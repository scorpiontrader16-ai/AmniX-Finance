...
// ingestion::v1 is at crate root (generated by Pass 1 in build.rs).
// processing.v1 is generated here by Pass 2, with extern_path pointing to
// crate::ingestion::v1 so prost doesn't re-generate ingestion types.
...
pub struct Engine {
    signal: SignalEngine,
    /// Reserved for time-series DB integration
    #[allow(dead_code)]
