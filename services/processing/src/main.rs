...
/// ingestion.v1 message types generated by Pass 1 in build.rs.
/// Declared at crate root so prost's extern_path(".ingestion.v1", "crate::ingestion::v1")
/// resolves correctly in the processing.v1 generated code.
pub mod ingestion {
    pub mod v1 {
